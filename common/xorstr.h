...
#define encryption(str) ::jm::xor_string([]() { return str; }, std::integral_constant<std::size_t, sizeof(str) / sizeof(*str)>{}, std::make_index_sequence<::jm::detail::_buffer_size<sizeof(str)>()>{})


#define xorstr(str) encryption(str).crypt_get()
...
#ifdef _KERNEL_MODE
#define xorstrKey "10:20:30"
#else 
#define xorstrKey __TIME__
#endif
